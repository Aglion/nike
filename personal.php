  ...
  <main>
    ...
    <aside class="sidebar" data-sidebar>
      ...
      <div class="sidebar-info">
        ...
        <div class="info-content">
          <h1 class="name" title="Richard hanrick"><?= $_SESSION['username'] ?></h1>
        ...
        <ul class="contacts-list">
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <a href="mailto:richard@example.com" class="contact-link"><?= $_SESSION['email'] ?></a>
            </div>
          ...
          <li class="contact-item">
            ...
            <div class="contact-info">
              ...
              <time datetime="1982-06-23">23 Июня, 1982</time>
            </div>
    ...
    <div class="main-content">
      ...
      <article class="about  active" data-page="about">
        ...
        <header>
          <h2 class="h2 article-title">Дополнительная информация</h2>
        </header>

        <section class="about-text">
          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias voluptas ipsa labore hic animi magni fugit deserunt consectetur quaerat possimus tempore pariatur, ducimus tenetur quibusdam veniam corrupti et neque saepe.
          </p>

          <p>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium doloribus nostrum adipisci inventore id pariatur. Sit labore incidunt totam, eaque odit nemo quibusdam deserunt assumenda, reprehenderit animi aspernatur hic veniam?
          </p>
        </section>
          ...
          <ul class="blog-posts-list">
            ...
            <li class="blog-post-item">
              <a href="#">
                ...
                <figure class="blog-banner-box">
                  <img src="img/blog-5.jpg" alt="The forgotten art of spacing" loading="lazy">
                </figure>
            ...
            <li class="blog-post-item">
              <a href="#">
                ...
                <figure class="blog-banner-box">
                  <img src="img/blog-6.jpg" alt="Design digest #79" loading="lazy">
                </figure>
